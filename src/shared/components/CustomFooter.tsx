...
const year= new Date();
  ...
  return (
    <footer className="py-5 bg-[#E5E3E3] max-[768px]:pr-6 max-[768px]:pl-6">
      ...
      <div className="w-full mb-3 py-2 bg-[#E5E3E3] lg:px-5 mt-8 sm:mt-10 sm:px-4 sm:flex sm:items-center sm:justify-between">
            <div >
            <img src="./images/logo/footerlogo.svg" className="h-16  lg:h-32 ms-4 sm:ms-0  " alt="" />
            </div>
          <div className="flex -mt-16 space-x-2 list-none sm:mt-0 text-stone-950 sm:justify-center mr-10 sm:mr-0">
        ...
        <div className="grid w-full gap-2  pb-2  pl-5 pr-5  mt-8 sm:mt-0 grid-cols-1 lg:grid-cols-12  ">
          <div className="pl-0 lg:pl-4 col-span-2 mt-5 lg:mt-0 lg:col-span-5" >
            <h2 className="font-semibold">Dental Care</h2>
            <p className="text-sm text-justify mt-0 lg:mt-4">
          ...
          <div className="text-stone-950 pl-0 lg:pl-4 col-span-2 mt-5 lg:mt-0 lg:col-span-3">
            <h2 className="font-semibold">Contact Us</h2>
            <p className="text-sm text-justify md:text-start mt-0 lg:mt-4 ">
            25G/1,Nazareth road near new 
            bus stand, <br/>
            Tuticorin District,
            Sathankulam-628704. <br/> 
            Phone No:+91 94437 50377. 
            </p>
            
          </div>

          <div className="pl-0 lg:pl-2 col-span-2 mt-5 lg:mt-0">
            <h2 className="font-semibold">Clinic Timings</h2>
            <p className="text-sm mt-0 lg:mt-4">
          ...
          <div className="text-stone-950 pl-0 lg:pl-4 col-span-2 mt-5 lg:mt-0">
            <h2 className="font-semibold">Quick Links</h2>

            <ul className="list-disc list-inside ml-4 mt-0 lg:mt-4">
  ...
  ">
         ...
         <span className="text-[rgba(59,79,162,1)]"> &copy;</span> Subhadentalcare {year.getFullYear()}. All rights reserved
            </div>
