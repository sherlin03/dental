            ...
            <section>
                ...
                <div className="mt-12 mb-12 container mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-12 mb-12">
                        <div>
                            <img src="./images/about/a1.png" alt="" className="w-full  lg:w-5/6 h-auto lg:h-[85%] " />
                    ...
                    {/* block 4 start */}
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-12 mb-12 ">
                                <div >
                                    <img src="./images/about/a5.png"  alt=""  className="h-auto lg:h-72 w-full xl:h-80 "/>
                                ...
                                <div className="mt-4">
                                    <img src="./images/about/a6.png" className=" h-auto lg:h-72 xl:h-96 w-full  " alt="" />
                                </div>
