                ...
                <div className="mt-12 mb-12 container mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        ...
                        <div className="mt-12 lg:mt-0 relative"   >
                            ...
                            <img src="./images/about/a10.png" alt=" " className="hidden sm:block absolute w-48  sm:w-56 md:w-72 lg:w-52 xl:w-64 2xl:w-80 h-[100px] md:h-[130px] lg:h-[100px] xl:h-[130px] 2xl:h-[150px] bottom-[9%] md:bottom-[8%] xl:bottom-[8%] 2xl:bottom-[13%] left-[18%] md:left-[15%] lg:left-[8%] xl:left-[10%] 2xl:left-[13%] z-20 transition-transform duration-1000 hover:scale-[1.1]" />
...
<img src="./images/about/a1.png" alt="" className="block sm:hidden w-full  lg:w-5/6 h-auto lg:h-[85%] " />
                    ...
                    {/* block 4 start */}
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mt-12 mb-12 ">
                                <div >
                                    <img src="./images/about/a5.png"  alt=""  className="h-auto lg:h-72 w-full xl:h-80 2xl:h-80 "/>
                                ...
                                <div className="mt-4">
                                    <img src="./images/about/a6.png" className=" h-auto lg:h-72 xl:h-80 2xl:h-[355px] w-full  " alt="" />
                                </div>
