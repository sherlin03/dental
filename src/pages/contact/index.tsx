    ...
    "
        ...
        <div className="container mx-auto relative mt-12 mb-2 lg:mb-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8  ">
            ...
            <div className="flex  justify-center h-[85vh] " data-aos="zoom-in-up" data-aos-duration="3000" >
        ...
        {/* block 2 End  */}
        {/* block 3 Start  */}
        <div className="w-full max-[390px]:mt-48 mt-28" data-aos="fade-up" data-aos-duration="3000" data-aos-easing="ease-in-out-cubic" >
